...
- `Post`: 공지·홍보자료 본문, 공개 상태, 운영 단계와 카테고리를 관리한다.
...
소셜 로그인용 계정 연결 모델, 편집자 역할, 게시글 작성자 관계는 아직 없다. `20260720000000_add_researcher_users` migration의 Production 적용은 별도 승인이 필요하다.
